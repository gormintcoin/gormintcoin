...
This means one can have an always-on gormintd instance running, and another local gormintd/gormint-qt instance which connects to this node and receives blocks from it.
