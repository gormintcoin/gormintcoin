...
In order to support loading of multiple wallets in gormint-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is gormint.cpp.
...
Changes to gormint.cpp
----------------------
gormint.cpp is the entry point into gormint-qt, and as such, will require some minor modifications to provide hooks for
