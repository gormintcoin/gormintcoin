...
This mechanism has been integrated into Bitcore-Node-gormint which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/gormint-Project/insight-api-gormint#web-socket-api](https://github.com/gormint-Project/insight-api-gormint#web-socket-api) 
* API: [https://github.com/gormint-Project/insight-api-gormint#swifttx-transactions](https://github.com/gormint-Project/insight-api-gormint#swifttx-transactions) 
...
By default, the gormint Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the gormint Core daemon:
