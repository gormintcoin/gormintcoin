gormint Core version 2.3.0 is now available from:

  <https://github.com/gormint-project/gormint/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/gormint-project/gormint/issues>

Compatibility
==============

gormint Core is extensively tested on multiple operating systems using
...
gormint Core should also work on most other Unix-like systems but is not
...
[
  {
    ...
    winner: {
        address: addr,    (string) gormint MN Address,
...
[
  {
    ...
    "addr": addr,      (string) Masternode gormint address
...
gormint Core now enables bloom filters by default to support SPV clients like mobile wallets. This feature can be disabled by using the `-peerbloomfilters` option on startup.
...
- #195 `aee05fe` [ZMQ] ZMQ integration for gormint (Mrs-X)
...
### Tests and QA
- #191 `3a778c3` [Tests] Fix the unit test suite for use with gormint (Fuzzbawls)
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/gormint-project-translations/).
