...
/** Utility functions used by the gormint Qt UI.
 */
namespace GUIUtil
{
...
// Render gormint addresses in monospace font
...
// Parse "gormint:" URI into recipient object, return true on successful parsing
