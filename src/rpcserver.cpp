...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "gormint server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* gormint features */
        {"gormint", "masternode", &masternode, true, true, false},
        {"gormint", "masternodelist", &masternodelist, true, true, false},
        {"gormint", "mnbudget", &mnbudget, true, true, false},
        {"gormint", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"gormint", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"gormint", "mnsync", &mnsync, true, true, false},
        {"gormint", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"gormint", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use gormintd, or the -server option to gormint-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> gormint-cli " + methodname + " " + args + "\n";
}
