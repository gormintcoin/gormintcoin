...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("gormint Core gormint-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  gormint-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded gormint transaction") + "\n" +
                               "  gormint-tx [options] -create [commands]   " + _("Create hex-encoded gormint transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded gormint transaction
